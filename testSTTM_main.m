function accuracy = testSTTM_main(trainX,trainY,testX,testY,num_classes)
...
bestAcc = 0;
cRange = 100;            % from previous test i concluded, this is the best value.
% NOW we can begin
