% This is the main setup for the testing on the systhetic RGB Data
...
k = 5;       % NOTE: PLEASE CHOOSE K, SUCH THAT IT CAN DEVIDE THE NUMBER OF ALL SAMPLES
% tic; accuracySVM = testSVM(X,Y,k); toc;
% tic; accuracySTM = testSTM(X,Y,k); toc;
% tic; accuracyHrSTM = testHrSTM(X,Y,k); toc;
% tic; accuracySTuM = testSTuM(X,Y,k); toc;